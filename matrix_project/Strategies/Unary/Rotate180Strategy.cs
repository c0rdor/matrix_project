...
namespace matrix_project.Strategies.Unary
{
    ...
    public class Rotate180Strategy<T> : IMatrixUnaryOperatorStrategy<T>
    {
        /// <summary>
        /// Gets the type of the operation.
        /// </summary>
        public MatrixOperationType OperationType => MatrixOperationType.Rotate180;
        ...
        public Task<IMatrix<T>> ExecuteOperationAsync(IMatrix<T> matrix, CancellationToken cancellationToken = default, int blockSize=64)
        {
            ...
            return Task.FromResult(MatrixBlockTransformer.Transform(matrix, n, n, (r, c) => (n - 1 - r, matrix.ColCount - 1 - c), cancellationToken, blockSize));
