...
namespace matrix_project.Strategies.Unary
{
    ...
    public class Rotate270Strategy<T> : IMatrixUnaryOperatorStrategy<T>
    {
        /// <summary>
        /// Gets the type of the operation.
        /// </summary>
        public MatrixOperationType OperationType => MatrixOperationType.Rotate270;
        ...
        public Task<IMatrix<T>> ExecuteOperationAsync(IMatrix<T> matrix, CancellationToken cancellationToken = default, int blockSize = 64)
        {
            ...
            return Task.FromResult(MatrixBlockTransformer.Transform(matrix, n, n, (r, c) => (matrix.ColCount - 1 - c, r), cancellationToken, blockSize));
        }
    }
